...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body class="bg-black font-sans antialiased">
        <div class="relative bg-gradient-to-b from-blue-700 to-black">
            <img src="{{ Vite::asset("resources/images/hero-background.png") }}" class="w-full opacity-50" alt="Hero Background" />
        </div>
        ...
        <div class="absolute top-0 w-full">
            ...
            <footer class="mx-auto mt-20 max-w-7xl px-5 py-16 text-center md:px-10 lg:px-32">
                <a href="{{ config("app.url") }}">
                    <img src="{{ Vite::asset("resources/images/logo@2.svg") }}" class="mb-3 h-[30px]" alt="Laravel PayHere Logo" />
                </a>
