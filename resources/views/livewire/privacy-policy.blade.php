<div class="mx-auto mt-10 max-w-5xl">
    <h1 class="my-6 text-start text-4xl text-white">Privacy Policy</h1>
    <div class="text-base text-white">
        ...
        <h2 class="my-6 text-xl">Information We Collect</h2>
        <p>When you visit our website, we may collect certain information about you, including:</p>
        <ul class="my-2 list-disc pl-10">
            <li>Personal identification information (such as your name and email address) provided voluntarily by you during the checkout process.</li>
        ...
        <h2 class="my-6 text-xl">Use Of Information</h2>
        ...
        <h2 class="my-6 text-xl">Information Sharing</h2>
