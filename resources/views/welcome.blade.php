...
@section("content")
    ...
    <section class="py-20">
        <div class="lp-feature relative flex overflow-hidden rounded-xl border border-white border-opacity-20 px-10 py-20 md:px-[80px] md:py-[140px]">
            <div class="max-w-2xl">
            ...
            <img class="absolute right-0 top-10 hidden w-1/3 md:block" src="{{ Vite::asset("resources/images/recurring-api-example.png") }}" alt="Recurring API Example" />
        </div>
    </section>
@endsection
